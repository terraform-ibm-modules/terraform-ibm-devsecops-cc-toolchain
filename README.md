...
| <a name="input_scc_evidence_namespace"></a> [scc\_evidence\_namespace](#input\_scc\_evidence\_namespace) | The kind of evidence to be displayed, cc or cd. | `string` | `"cc"` | no |
...
| <a name="input_scc_scope"></a> [scc\_scope](#input\_scc\_scope) | Security and Compliance Scope. | `string` | `"DevsecOps Scope"` | no |
| <a name="input_scc_trigger_scan"></a> [scc\_trigger\_scan](#input\_scc\_trigger\_scan) | Default:  disabled. Can be set to 'enabled'. Note each scan may incur a charge. | `string` | `"disabled"` | no |
